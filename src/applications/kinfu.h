...
{
public:
	Kinfu(int w, int h, bool useColour, double fx, double fy, double ox, double oy, int volRes,
			float volRad, float mincostheta = 0.1, float knear = 0.4, float kfar = 4.0,
			float trunc_dist_factor = 2.0);
