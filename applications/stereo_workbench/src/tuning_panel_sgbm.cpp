...
#include <reco/stereo_workbench/tuning_panel_sgbm.hpp>
...
void tuning_panel_sgbm::connect_specialized_controls(const matcher_qt_wrapper_sgbm& processor){
...
void tuning_panel_sgbm::construct_specialized_controls(){
...
tuning_panel_sgbm::~tuning_panel_sgbm(){
