...
parser = ap.ArgumentParser(description='A simple utility that overlays one image over another.')

parser.add_argument("-f", "--folder", help="Folder to work in", 
                    required=False, default= "./")
parser.add_argument("-i", "--images", nargs=2, help="Names of two image files", 
                    required=False, default= ["left.png","right.png"])
parser.add_argument("-w", "--weights", nargs=2, help="Weights to use for overlay (must add up to one)", 
