...
*/
class LegacyOpenCVImageAdapter :	public OvImageAdapter
{
  LegacyOpenCVImageAdapter(){}; /**< to prevent the default constructor from being used */

public:
  LegacyOpenCVImageAdapter(IplImage*im);
  virtual ~LegacyOpenCVImageAdapter();
...
protected:
  ...
  double (LegacyOpenCVImageAdapter::*getPixelfptr) (int row, int column, int channel) const; /**< function pointer used to store getpixel function appropriate for image datatype */
  void   (LegacyOpenCVImageAdapter::*setPixelfptr) (double value, int row, int column, int channel); /**< function pointer used to store setpixel function appropriate for image datatype */
